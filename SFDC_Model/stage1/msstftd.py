...
from stage1.modules import NormConv2d
...
class MultiScaleSTFTDiscriminator(nn.Module):
    ...
    """
    def __init__(self, filters: int, in_channels: int = 1, out_channels: int = 1,
                 n_ffts: tp.List[int] = [512, 1024, 2048, 4096], hop_lengths: tp.List[int] = [64, 128, 256, 512],
                 win_lengths: tp.List[int] = [256, 512, 1024, 2048],**kwargs):
        super().__init__()
