...
def save_master_checkpoint(epoch, model, optimizer,scheduler, ckpt_name):  
    ...
    state_dict = {  
        ...
        #'optimizer_TEencoder_state_dict': optimizer_TEencoder.state_dict(),  
        'scheduler_state_dict': scheduler.state_dict(), 
        #'scheduler_TEencoder_state_dict': scheduler_TEencoder.state_dict(), 
    }  
    torch.save(state_dict, ckpt_name) 
def save_master_checkpoint_two(epoch, model, optimizer_main,optimizer_emotion,scheduler, ckpt_name):  
    """save master checkpoint
    ...
    state_dict = {  
        ...
        'optimizer_emotion_state_dict': optimizer_emotion.state_dict(),
        #'optimizer_TEencoder_state_dict': optimizer_TEencoder.state_dict(),  
        'scheduler_state_dict': scheduler.state_dict(), 
        #'scheduler_TEencoder_state_dict': scheduler_TEencoder.state_dict(), 
    }  
    torch.save(state_dict, ckpt_name) 
def save_master_checkpoint_mi(epoch, model, optimizer, ckpt_name):  
    """save master checkpoint
